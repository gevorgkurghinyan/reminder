...
public class ReminderProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.gevkurg.reminder/reminders" will map to the
        // integer code {@link #REMINDERS}. This URI is used to provide access to MULTIPLE rows
        // of the reminders table.
        uriMatcher.addURI(ReminderContract.CONTENT_AUTHORITY, ReminderContract.PATH_REMINDERS, REMINDERS);

        // The content URI of the form "content://com.gevkurg.reminder/reminders/#" will map to the
        // integer code {@link #REMINDER_ID}. This URI is used to provide access to ONE single row
        // of the reminders table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.gevkurg.reminder/reminders/3" matches, but
        // "content://com.gevkurg.reminder/reminders" (without a number at the end) doesn't match.
        uriMatcher.addURI(ReminderContract.CONTENT_AUTHORITY, ReminderContract.PATH_REMINDERS + "/#", REMINDER_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case REMINDER_ID:
                ...
                // For an example URI such as "content://com.gevkurg.reminder/reminders/3",
                ...
                // This will perform a query on the reminders table where the _id equals 3 to return a
    ...
    private Uri insertReminder(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(ReminderContract.ReminderEntry.COLUMN_NAME);
        if (name == null) {
    ...
    /**
     * Update reminders in the database with the given content values. Apply the changes to the rows
     * specified in the selection and selection arguments (which could be 0 or 1 or more reminders).
     * Return the number of rows that were successfully updated.
     */
    private int updateReminder(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link ReminderEntry#COLUMN_NAME} key is present,
        // check that the name value is not null.
        if (values.containsKey(ReminderContract.ReminderEntry.COLUMN_NAME)) {
            String name = values.getAsString(ReminderContract.ReminderEntry.COLUMN_NAME);
            if (name == null) {
                throw new IllegalArgumentException("Reminder requires a name");
            }
